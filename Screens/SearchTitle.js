...
import { StyleSheet, View, Text, TextInput, FlatList, ActivityIndicator, TouchableOpacity, Modal } from 'react-native';
...
export default function SearchTitle () {
    ...
    async function loadData() {
        setLoad(true);
        await fetch("https://www.googleapis.com/books/v1/volumes?q=intitle:"+bookName+'&maxResults=40')
